...
public class Sredni_Test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sredni__test);

        if(savedInstanceState == null){
            lastOrientation = getResources().getConfiguration().orientation;
        }

        slowo = findViewById(R.id.slowo_test_sredni);
        ...
        koniec = findViewById(R.id.koniectestsredni);
        ...
        odp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(liczba_pytan <= 19){
                    ...
                    Toast.makeText(Sredni_Test.this,"To było już ostatnie pytanie",Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        koniec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Sredni_Test.this);
                builder.setMessage(R.string.czy_pewny_koniec_testu).setTitle(R.string.koniec_testu);
                builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(Sredni_Test.this,Wynik_Testu.class).putExtra("punkty",wynik));
                    }
                });
                builder.setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(Sredni_Test.this,"Test nie został zakończony",Toast.LENGTH_LONG).show();
                    }
                });
